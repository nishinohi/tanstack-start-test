        ...
        <nav className="flex-1 overflow-y-auto p-4">
          ...
          {groupedExpanded.StartSSRDemo && (
            <div className="ml-4 flex flex-col">
              ...
              >
                <StickyNote size={20} />
                <span className="font-medium">Non-streaming SSR Client Fetch DB</span>
              </Link>
              ...
              >
                <StickyNote size={20} />
                <span className="font-medium">Non-streaming SSR DB</span>
              </Link>
              ...
              >
                <StickyNote size={20} />
                <span className="font-medium">Streaming SSR DB with Query</span>
              </Link>
            </div>
          )}
